...
UNARY_BOOL              = ["Not"]
BINARY_BOOL             = ["And Operator", "Or Operator"]
INFINITE_ARITY_BOOL     = ["And Operator Infinite Args", "Or Operator Infinite Args"]
MKAY                    = ["MKAY"]


# TODO: Group grammar properly

# TODO: Redo structure
# START 
# - STATEMENT
#   - <all possible values of statement>
#   - 


#          STATEMENT
#         /         \
#       values      next STATEMENT
...
class Parser:
    def __init__(self, lexemesList):
        ...
        self.MODE_UNARY_BOOL            = False
        self.MODE_BINARY_BOOL           = False
        self.MODE_INFINITE_ARITY_BOOL   = False

    # TODO: check if this is still necessary after clean-up
    # Reset most flags
    def reset_modes(self):
        ...
        self.MODE_ARITHMETIC            = False
        self.MODE_SINGLE_LINE_COMMENT   = False
        # self.MODE_MULTI_LINE_COMMENT  -> Value should not reset
        self.MODE_FUNCTION              = False
        self.MODE_UNARY_BOOL            = False
        self.MODE_BINARY_BOOL           = False
        self.MODE_INFINITE_ARITY_BOOL   = False
    ...
    def handle_variable_identifier(self):
        ...
        if self.MODE_I_HAS_A:                       self.expectation = ["Assignment Operator", *LINE_BREAK, *COMMENT_START]
            ...
            # TODO: in VARIABLE_IDENTIFIER OR LITERAL[:1]
            if prev2_token in VARIABLE_IDENTIFIER:  self.expectation = [*LINE_BREAK, *COMMENT_START]
            else:                                   self.expectation = AN_KEYWORD
        elif self.MODE_UNARY_BOOL:                  self.expectation = [*LINE_BREAK, *COMMENT_START]
        elif self.MODE_BINARY_BOOL:
            # TODO: in VARIABLE_IDENTIFIER OR LITERAL[:1]
            if prev2_token in VARIABLE_IDENTIFIER:  self.expectation = [*LINE_BREAK, *COMMENT_START]
            else:                                   self.expectation = AN_KEYWORD
        elif self.INFINITE_ARITY_BOOL:              self.expectation = [AN_KEYWORD]
    ...
    def handle_literal(self, token_class):
        ...
        if token_class == "String Literal":         self.expectation = STRING_DELIMETER
            ...
            if prev_token in AN_KEYWORD:            self.expectation = LINE_BREAK
            elif token_class in LITERAL[:1]:        self.expectation = AN_KEYWORD
    ...
    def handle_arithmetic_operator(self):
        ...
        self.expectation = [*VARIABLE_IDENTIFIER, *ARITHMETIC_OPERATOR, *LITERAL[:1], *AN_KEYWORD]
    ...
    def handle_unary_bool(self):
        self.MODE_UNARY_BOOL = True
        self.expectation = [*VARIABLE_IDENTIFIER, *LITERAL]

    # BINARY BOOL
    # | VARIABLE_IDENTIFIER, LITERAL
    def handle_binary_bool(self):
        self.MODE_BINARY_BOOL = True
        self.expectation = [*VARIABLE_IDENTIFIER, *LITERAL]

    # INFINITE ARITY BOOL
    # | VARIABLE_IDENTIFIER, LITERAL
    def handle_infinite_arity_bool(self):
        self.MODE_INFINITE_ARITY_BOOL = True
        self.expectation = [*VARIABLE_IDENTIFIER, *LITERAL]
    ...
    def evaluate(self, token_class):
        ...
        elif token_class in AN_KEYWORD:             self.handle_and_operator()
